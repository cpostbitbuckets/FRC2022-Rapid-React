...
public final class WPI_TalonFXSteerControllerFactoryBuilder {
  ...
  public WPI_TalonFXSteerControllerFactoryBuilder withVoltageCompensation(
  ...
  public WPI_TalonFXSteerControllerFactoryBuilder withCurrentLimit(
    double currentLimit
  ) {
  ...
  private class FactoryImplementation<T>
    implements
      SteerControllerFactory<ControllerImplementation, WPI_TalonFXSteerConfiguration<T>> {
    ...
    public ControllerImplementation create(
      ...
      WPI_TalonFX motor = steerConfiguration.getMotor();
      checkCtreError(
