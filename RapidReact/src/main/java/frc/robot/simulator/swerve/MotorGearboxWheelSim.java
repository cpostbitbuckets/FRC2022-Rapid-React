...
class MotorGearboxWheelSim {
  ...
  public void update(
    double groundVelocity_mps,
    double motorVoltage,
    double dtSeconds
  ) {
    double wheelRotationalSpeed_radPerSec = groundVelocity_mps / wheelRadius_m;
    double motorRotationalSpeed_radPerSec =
      wheelRotationalSpeed_radPerSec * gearRatio;

    double motorTorque_Nm =
      motor.KtNMPerAmp *
      motor.getCurrent(motorRotationalSpeed_radPerSec, motorVoltage);
    ...
    wheelSpeed_RPM =
      Units.radiansPerSecondToRotationsPerMinute(
        wheelRotationalSpeed_radPerSec
      );
    motorSpeed_RPM =
      Units.radiansPerSecondToRotationsPerMinute(
        motorRotationalSpeed_radPerSec
      );
  }
